$(function () {
    ...
    $.fn.selectmenu = function (settings) {
        ...
        return $(this).each(function () {
            ...
            menu.appendTo(selectElement.parent());
            ...
            menu.bind('show', function () {
                $(this)
                    //reappend to the page
                    .appendTo(selectElement.parent())
                    //remove hidden class
                    ...
                    .css({
                        top: button.offset().top + button.height() - button.offsetParent().offset().top,
                        left: button.offset().left - button.offsetParent().offset().left
                    })
